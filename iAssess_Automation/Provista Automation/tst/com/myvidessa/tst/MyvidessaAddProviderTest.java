...
public class MyvidessaAddProviderTest {
	...
	Logger logger = Logger.getLogger("Provista Automation Add Provider");

	@BeforeClass
	public void setup() {
		commonhelperimpl.initializeLog4j(logger);
	...
	public void addProviderWithNoDataFilled() {
		try {
			...
			Thread.sleep(1000);
			driver.findElement(By.id(MyvidessaAddProviderLocator.PROVIDER_ALERT_CLOSE_ID)).click();
			logger.info("closed error alert box");
			Thread.sleep(1000);
			driver.findElement(By.xpath(MyvidessaAddProviderLocator.PROVIDER_CLOSE_ICON_XPATH)).click();
			logger.info("closed Add provider form");
		} catch (Exception e) {
	...
	public void addProviderWithValidData(int title, String fname, String mname, String lname, String email, String phone,
		...
		try {
			...
			logger.info("Provider Added Successfully || Test Case Passed");
		} catch (Exception e) {
			logger.info("Exception occured|| Test Case Failed");
			logger.info(e.getMessage());
		}
	...
	@Test(priority = 2,dataProvider="InvalidDataToAddProvider")
	public void addProviderWithSomeInvalidData(int title, String fname, String mname, String lname, String email, String phone,
			String NPINumber, String NPIName, String facname, String facphone, String facfax, String addline1,
			String addline2, String city, int state, String zip) {
		try {
			logger.info("Add Provider with some invalid data in all fields");
			providerhelperimpl.addProvider(driver, title, fname, mname, lname, email, phone, NPINumber, NPIName, facname, facphone, facfax, addline1, addline2, city, state, zip);
	...
	private Object[][] validDataToAddProvider()
	{
		...
		data[0][5]="112312342"+commonhelperimpl.randomNumberGenerator(9);
		...
		data[0][9]="112312340"+commonhelperimpl.randomNumberGenerator(9);
		data[0][10]="112312349"+commonhelperimpl.randomNumberGenerator(9);
	...
	@DataProvider(name="InvalidDataToAddProvider")
	private Object[][] invalidDataToAddProvider()
	{
		Object[][] data=new Object[1][16];
		data[0][0]=commonhelperimpl.randomNumberGenerator(3);
		data[0][1]="Test"+"fname"+commonhelperimpl.generateString("aefgshklhti", 2);
		data[0][2]="Test"+"mname"+commonhelperimpl.generateString("aefgshklhti", 2);
		data[0][3]="Test"+"lname"+commonhelperimpl.generateString("aefgshklhti", 2);
		data[0][4]="test"+"email"+"@"+commonhelperimpl.generateString("aefgshklhti", 3);
