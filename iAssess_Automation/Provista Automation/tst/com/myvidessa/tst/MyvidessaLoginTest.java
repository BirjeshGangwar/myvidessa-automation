...
public class MyvidessaLoginTest {
	...
	public void initializeLogging() {
		myvidessacommonimpl.initializeLog4j(logger);
	}
	...
	public void loginWithValidCredentials(String username, String password) {
		try {
			...
			logger.info("Login Successfully into system|| Test Case Passed");	
			Thread.sleep(5000);
			loginhelperimpl.performLogout(driver);
			logger.info("Logout Successfully from system|| Test Case Passed");
			Thread.sleep(1000);
		} catch (Exception e) {
